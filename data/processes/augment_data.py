...
class AugmentData(DataProcess):
    ...
    def resize_image(self, image, opt='height'):
    ...
    def process(self, data):
        ...
        #
        #     cv2.polylines(
        #         box_data, [np.reshape(np.int32(test_poly), (-1, 1, 2))], True, (0, 0, 255),10
        #     )
        #
        # cv2.imwrite('testpoly.png', box_data)
        #
        # import ipdb;
        # ipdb.set_trace()
